...
<div class="bg-cds-blue py-12 md:py-16 text-white text-center">
    <div class="container mx-auto px-4">
        ...
        <p class="text-lg text-gray-300 max-w-2xl mx-auto">
            <span data-lang="bn">সিটিজেন ডেভেলপমেন্ট সোসাইটি (CDS)-এর লক্ষ্য, উদ্দেশ্য এবং এর পেছনের মানুষদের সম্পর্কে জানুন।</span>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="prose prose-lg text-gray-700 mx-auto text-justify">
            <div data-lang="bn">
                <p class="mb-4">
                    সিটিজেন ডেভেলপমেন্ট সোসাইটি (CDS) একটি সমাজকল্যাণমূলক, অলাভজনক ও স্বেচ্ছাসেবী প্রতিষ্ঠান। সমাজের অবহেলিত, সুবিধা-বঞ্চিত এবং দরিদ্র মানুষের জীবনযাত্রার মান উন্নয়নের এক মহান ব্রত নিয়ে আমাদের এই পথচলা শুরু হয়। আমরা বিশ্বাস করি, প্রতিটি নাগরিকের সুশিক্ষা, সুস্বাস্থ্য এবং একটি নিরাপদ পরিবেশে বেঁচে থাকার অধিকার রয়েছে।
                </p>
                <p class="mb-4">
                    প্রতিষ্ঠার পর থেকে CDS শিক্ষা প্রসার, স্বাস্থ্যসেবা নিশ্চিতকরণ, সামাজিক সচেতনতা বৃদ্ধি এবং সুশাসন প্রতিষ্ঠার লক্ষ্যে নিরলসভাবে কাজ করে যাচ্ছে। আমাদের স্বেচ্ছাসেবীরা তৃণমূল পর্যায়ে কাজ করে সমাজের প্রকৃত সমস্যাগুলো চিহ্নিত করে এবং সেগুলো সমাধানের জন্য যুগোপযোগী পদক্ষেপ গ্রহণ করে। 
                </p>
                <p>
