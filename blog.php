        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <?php if(empty($blogs)): ?>
                <div class="col-span-full text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                    <p class="text-gray-500 font-medium">কোনো ব্লগ পাওয়া যায়নি।</p>
                </div>
            <?php else: ?>
                ...
                <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden transition-all hover:shadow-md group flex flex-col">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <h3 class="text-xl font-serif font-bold text-gray-900 mb-3 group-hover:text-primary transition-colors line-clamp-2"><?php echo e($blog['title']); ?></h3>
                        ...
                        <a href="blog_details.php?id=<?php echo $blog['id']; ?>" class="text-primary font-medium text-sm hover:underline flex items-center gap-1 mt-auto">
                            বিস্তারিত পড়ুন <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                        </a>
                    </div>
                </div>
                <?php endforeach; ?>
